...
const filteredProducts = computed(() => {
    ...
    return props.products.filter((product: any) => product.category?.slug === activeTab.value);
});
</script>
    ...
    <section class="bg-white py-16 dark:bg-gray-900">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mb-12 text-center">
                <h2 class="text-3xl font-bold text-gray-900 sm:text-4xl dark:text-white">Nouveaux Arrivages</h2>
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-400">Découvrez nos dernières nouveautés</p>
            </div>
