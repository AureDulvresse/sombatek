...
<template>
    <section
        class="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50 py-16 dark:from-gray-800 dark:to-gray-700">
            ...
            <div class="relative">
                ...
                <div class="relative h-[400px] overflow-hidden rounded-2xl">
                    <div v-for="(ad, index) in advertisements" :key="ad.id"
                        class="absolute inset-0 h-full w-full transition-all duration-500" :class="{
                ...
                <div class="mt-4 flex justify-center space-x-2">
                    <button v-for="(ad, index) in advertisements" :key="ad.id" @click="currentIndex = index"
                        class="h-2 w-2 rounded-full transition-all" :class="{
