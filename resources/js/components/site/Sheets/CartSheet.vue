    ...
    <TransitionRoot as="template" :show="isOpen">
        <Dialog as="div" class="relative z-50" @close="emit('close')">
            <TransitionChild
                ...
                leave-to="opacity-0"
            >
                <div class="bg-opacity-75 fixed inset-0 bg-black/70 backdrop-blur-sm transition-opacity" />
            </TransitionChild>
                                ...
                                <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl dark:bg-gray-900">
                                    <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                                        <div class="flex items-start justify-between">
                                            <Dialog.Title class="text-lg font-medium text-gray-900 dark:text-white">Mon panier</Dialog.Title>
                                    ...
                                    <div class="border-t border-gray-200 px-4 py-6 sm:px-6 dark:border-gray-700">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div
                                                v-if="cartStore.discount_total > 0"
                                            ...
                                            <div
                                                v-if="cartStore.promotion_discount > 0"
                                                class="flex justify-between text-sm text-green-600 dark:text-green-400"
                                            >
